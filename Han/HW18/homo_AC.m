    ...
    for i = 1:size(uniconin,1)
        for j = 1:E4row
            ...
            if fcon == 1
                ...
                Id(step,1) = Id(step,1) ...
                    - esi*e0*edgeE4(j,1)/lenE4(j,1)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,2),2))-dphi(X1_sorted(E4(j,1),2)))*width...
                    - esi*e0*edgeE4(j,3)/lenE4(j,3)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,3),2))-dphi(X1_sorted(E4(j,1),2)))*width;
            ...
            elseif fcon == 2
                ...
                Id(step,1) = Id(step,1) ...
                    - esi*e0*edgeE4(j,2)/lenE4(j,2)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,3),2))- dphi(X1_sorted(E4(j,2),2)))*width...
                    - esi*e0*edgeE4(j,1)/lenE4(j,1)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,1),2))- dphi(X1_sorted(E4(j,2),2)))*width;
            ...
            elseif fcon == 3
                ...
                Id(step,1) = Id(step,1) ...
                    - esi*e0*edgeE4(j,3)/lenE4(j,3)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,1),2)) - dphi(X1_sorted(E4(j,3),2)))*width...
                    - esi*e0*edgeE4(j,2)/lenE4(j,2)*(2*pi*freq*iN)*(dphi(X1_sorted(E4(j,2),2)) - dphi(X1_sorted(E4(j,3),2)))*width;
            end
        end
    end
end
