...
for bias_Vd=1:11 %%% Vd는 1V까지 올림.
    ...
    if bias_Vd>=2
        ...
        FILENAME = sprintf('./data/Homework15_Vd/Homework15_Vd_%.2fV.mat',Vd_load);
        load(FILENAME)
        Vd=Vd_load+0.1;
        clearvars Vd_load
    end
...
% Current %
    ...
    FILENAME = sprintf('./data/Homework15_Vd/Homework15_Vd_%.2fV_current.mat',Vd);
    save(FILENAME, 'I_Vd');
