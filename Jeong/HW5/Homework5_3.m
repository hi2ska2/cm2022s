...
Dirichlet_BC = importdata("Dirichlet_BC_mos.txt"); % Dirichlet_BC = [index potential]
F_1 = importdata("element_3_1.txt");
F_2 = importdata("element_3_2.txt");
F_3 = importdata("element_3_3.txt");
F_4 = importdata("element_3_4.txt");
Element = [F_1; F_2; F_3; F_4];
point = importdata("Vertex_3.txt");
...
% Visualize 
figure(5);
patch('Faces',Element,'Vertices',point(:,[1 2]), 'EdgeColor','black','FaceColor','none','LineWidth',0.5);
xlabel('X');
ylabel('Y');
title('Structure')

figure(6);
patch('Faces',Element,'Vertices',point(:,[1 2]), 'FaceVertexCData',phi, 'EdgeColor','black','FaceColor','interp');
title('Structure')
xlabel('X');
ylabel('Y');
colorbar
