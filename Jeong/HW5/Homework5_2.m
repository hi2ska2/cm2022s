...
Dirichlet_BC = importdata("Dirichlet_BC_rec.txt"); % Dirichlet_BC = [index potential]
F_1 = importdata("element_2_1.txt");
F_2 = importdata("element_2_2.txt");
F_3 = importdata("element_2_3.txt");
Element = [F_1; F_2; F_3];
point = importdata("Vertex_2.txt");
