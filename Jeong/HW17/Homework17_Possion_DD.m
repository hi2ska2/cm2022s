...
%% Build a Structure %%
% Vertex 값 작성
Vertex=vertex_doublegate(0,0, 120,5, 10, 1);    % vertex = vertex_doublegate(x1, y1, x2, y2, dx, dy), [nm]

% anode_BC 불러오기
anode_BC_tmp=Contact(0,0,0,5,V_T*log(Nd/n_int));
...
cathode_BC_tmp=Contact(120,0, 120,5, V_T*log(Nd/n_int));
m=0; n=0; % element로 이루어진 경계조건 계산하기 위해 변환
...
% Element 값 입력
Element_si = element(0,0, 120,5); % Element = element(x1, y1, x2, y2), [nm]
...
save('./data/Homework17_possion.mat')
