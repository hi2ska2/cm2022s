...
%% Build a Structure %%
% Vertex 값 작성
length_x=120; length_y=100; dx=4; dy=5;
...
cathode_BC_tmp=Contact(120,0, 120,100, V_T*log(Nd/n_int));
m=0; n=0; % element로 이루어진 경계조건 계산하기 위해 변환
...
% Element 값 입력
Element_si = element(0,0, 120,100); % Element = element(x1, y1, x2, y2), [nm]
...
save('./data/homework21_possion.mat')
...
hold on
plot(Vertex(130,1),Vertex(130,2),'s','MarkerSize',10,'MarkerEdgeColor','red','MarkerFaceColor',[1 .6 .6])
hold on
plot(Vertex(150,1),Vertex(150,2),'s','MarkerSize',10,'MarkerEdgeColor','red','MarkerFaceColor',[1 .6 .6])
hold on
plot(Vertex(326,1),Vertex(326,2),'s','MarkerSize',10,'MarkerEdgeColor','red','MarkerFaceColor',[1 .6 .6])
hold on
plot(Vertex(502,1),Vertex(502,2),'s','MarkerSize',10,'MarkerEdgeColor','red','MarkerFaceColor',[1 .6 .6])
hold on
plot(Vertex(522,1),Vertex(522,2),'s','MarkerSize',10,'MarkerEdgeColor','red','MarkerFaceColor',[1 .6 .6])
hold on
hold off