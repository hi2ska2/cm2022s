...
%% Build a Structure %%
% Vertex 값 작성
Vertex=vertex_doublegate(0,0, 50,14, 1, 0.5);    % vertex = vertex_doublegate(x1, y1, x2, y2, dx, dy), [nm]
...
Element_si_source = element(0,2, 15,12);
Element_si_channel = element(15,2, 35,12);
Element_si_drain = element(35,2, 50,12);
...
%% Save
save('./data/Homework14_possion.mat')
