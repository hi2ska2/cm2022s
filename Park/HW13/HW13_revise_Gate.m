...
for bias = 0:10
    ...
    for Newton = 1:20
        ...
        if norm(abs(update_DD_vector_Gate(1+VR1:3:VR1+3*VR2,1),inf)) < 1e-15
            break;
        end
    ...
    for tt=1:w_row
        ...
        for rr = 1:K_row
            ...
            if K(rr,1) <= R_row2
                ...
                In(bias+1,1) = In(bias+1,1) + coeff_Jn*(elec(VR1+V2,1)*Ber(x21) - elec(VR1+V1,1)*Ber(x12))*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                In(bias+1,1) = In(bias+1,1) + coeff_Jn*(elec(VR1+V3,1)*Ber(x31) - elec(VR1+V1,1)*Ber(x13))*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
                Ip(bias+1,1) = Ip(bias+1,1) + coeff_Jp*(hole(VR1+V2,1)*Ber(x12) - hole(VR1+V1,1)*Ber(x21))*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                Ip(bias+1,1) = Ip(bias+1,1) + coeff_Jp*(hole(VR1+V3,1)*Ber(x13) - hole(VR1+V1,1)*Ber(x31))*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            ...
            elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                ...
                In(bias+1,1) =  In(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(elec(VR1+V1,1)*Ber(x12) - elec(VR1+V2,1)*Ber(x21)));
                In(bias+1,1) =  In(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(elec(VR1+V3,1)*Ber(x32) - elec(VR1+V2,1)*Ber(x23)));
                Ip(bias+1,1) =  Ip(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(hole(VR1+V1,1)*Ber(x21) - hole(VR1+V2,1)*Ber(x12)));
                Ip(bias+1,1) =  Ip(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(hole(VR1+V3,1)*Ber(x23) - hole(VR1+V2,1)*Ber(x32)));
            ...
            elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                ...
                In(bias+1,1) = In(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(elec(VR1+V1,1)*Ber(x13) - elec(VR1+V3,1)*Ber(x31)));
                In(bias+1,1) = In(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(elec(VR1+V2,1)*Ber(x23) - elec(VR1+V3,1)*Ber(x32)));
                Ip(bias+1,1) = Ip(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(hole(VR1+V1,1)*Ber(x31) - hole(VR1+V3,1)*Ber(x13)));
                Ip(bias+1,1) = Ip(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(hole(VR1+V2,1)*Ber(x32) - hole(VR1+V3,1)*Ber(x23)));
            end
