    ...
    elseif Table(ii,1) == 2     %region2
        ...
        for rr = 1:K_row
            if Table(ii,3) == Potential
                ...
                %                         jj = 1;
                %
                %                         %             res(ii,1) = res(E_R1(ii,jj),1) + eox*(phi(E_R1(ii,jj+1),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj)/L(ii,jj)) + eox*(phi(E_R1(ii,jj+2),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj+2)/L(ii,jj+2));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+2)-6)+8) = 1;% esi*(edge(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+1)-6)+8) = 1;%esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+8) = 1;%-esi*(edge(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2))-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %
                %
                %                     elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                %                         jj = 2;
                ...
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+1)-6)+8) = 1;%esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+8) =  1;%-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))-esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-1)-6)+8) = 1;%esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                %
                %
                %
                %                     elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                ...
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-2)-6)+8) = 1;%esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-1)-6)+8) = 1;%esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+8) = 1;%-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))-esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                %                     end
                %
                ...
                %
                %                         %             res(ii,1) = res(E_R1(ii,jj),1) + eox*(phi(E_R1(ii,jj+1),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj)/L(ii,jj)) + eox*(phi(E_R1(ii,jj+2),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj+2)/L(ii,jj+2));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+2)-6)+9) =1;%+esi*(edge(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+1)-6)+9) = 1;%+esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+9) = 1;%-esi*(edge(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2))-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %
                %
                %                     elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                %                         jj = 2;
                ...
                %                         %                     res(E_R1(ii,jj),1) = res(E_R1(ii,jj),1) + eox*(phi(E_R1(ii,jj-1),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj-1)/L(ii,jj-1)) + eox*(phi(E_R1(ii,jj+1),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj)/L(ii,jj));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj+1)-6)+9) = 1;%+esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+9) =  1;%-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))-esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-1)-6)+9) = 1;%+esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                %
                %
                %
                %                     elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                ...
                %
                %                         %                         res(E_R1(ii,jj),1) = res(E_R1(ii,jj),1) + eox*(phi(E_R1(ii,jj-2),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj)/L(ii,jj)) + eox*(phi(E_R1(ii,jj-1),1)-phi(E_R1(ii,jj),1))*(edge(ii,jj-1)/L(ii,jj-1));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-2)-6)+9) = 1;%+esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                % %                         Jaco(ii, 3*(E_R2(K(rr,1),jj-1)-6)+9) = 1;%+esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
                %                         Jaco(ii, 3*(E_R2(K(rr,1),jj)-6)+9) = 1;%-esi*(edge(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))-esi*(edge(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1));
            end
