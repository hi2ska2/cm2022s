                    ...
                    elseif Table(ii,3) == eDensity
                        ...
                        for rr = 1:K_row
                            if K(rr,1) <= R_row2
                                ...
                                res(ii,1) = - (q/4)/deltat*(Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj)+Area(K(rr,1)+R_row1,jj+2)*L(K(rr,1)+R_row1,jj+2))*(delec_old(VR1+V1,1));
                            ...
                            elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                                ...
                                % AC
                                res(ii,1) = - (q/4)/deltat*(Area(K(rr,1)+R_row1,jj-1)*L(K(rr,1)+R_row1,jj-1)+Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj))*(delec_old(VR1+V2,1));
                            ...
                            elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                                ...
                                % AC
                                res(ii,1) = - (q/4)/deltat*(Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj)+Area(K(rr,1)+R_row1,jj-1)*L(K(rr,1)+R_row1,jj-1))*(delec_old(VR1+V3,1));
                    ...
                    elseif Table(ii,3) == hDensity
                        ...
                        for rr = 1:K_row
                            ...
                            if K(rr,1) <= R_row2
                                ...
                                % AC
                                res(ii,1) = (q/4)/deltat*(Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj)+Area(K(rr,1)+R_row1,jj+2)*L(K(rr,1)+R_row1,jj+2))*(dhole_old(VR1+V1,1));
                            ...
                            elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                                ...
                                % AC
                                res(ii,1) = (q/4)/deltat*(Area(K(rr,1)+R_row1,jj-1)*L(K(rr,1)+R_row1,jj-1)+Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj))*(dhole_old(VR1+V2,1));
                            ...
                            elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                                ...
                                % AC
                                res(ii,1) =  (q/4)/deltat*(Area(K(rr,1)+R_row1,jj)*L(K(rr,1)+R_row1,jj)+Area(K(rr,1)+R_row1,jj-1)*L(K(rr,1)+R_row1,jj-1))*(dhole_old(VR1+V3,1));
    ...
    for n=1:C_col
        for ii =1: C_row
            if ii <= (C_row/2) % Bottom Gate
                ...
                Jaco(V,:) =0;
                Jaco(V,V) = 1;
                res(V,1)= Amp*sin(2*pi*freq*t(:,T_step));
                ...
                res(VR1+3*VR2+V,1)= Amp*sin(2*pi*freq*t(:,T_step));
            end
        end
    end
    ...
    for tt=1:w_row
        ...
        for rr = 1:K_row
            ...
            if K(rr,1) <= R_row2
                ...
                Jd(T_step,1) = Jd(T_step,1) - esi*e0/deltat*((dphi(VR1+V3,1)-dphi(VR1+V1,1))-(dphi_old(VR1+V3,1)-dphi_old(VR1+V1,1)))*Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2);
