clear; clc;
load("Double_gate_raming(Vd=1,Vg=0.7).mat")
...
dphi=zeros(size(phi));
delec=zeros(size(elec));
dhole=zeros(size(hole));
...
sol_AC_doublegate(:,1) = Cmatrix* update_scaled;

dphi(1:VR1,1) = sol_AC_doublegate(1:VR1,1);
dphi(1+VR1:VR2+VR1,1) = sol_AC_doublegate(1+VR1:3:VR1+3*VR2,1);
dphi(1+VR1+VR2:T,1) =  sol_AC_doublegate(1+VR1+3*VR2:T_row,1);

delec(1+VR1:1:VR2+VR1,1) = sol_AC_doublegate(2+VR1:3:VR1+3*VR2,1);
dhole(1+VR1:1:VR2+VR1,1) = sol_AC_doublegate(3+VR1:3:VR1+3*VR2,1);

sol_AC_doublegate_poi(:,1) = abs(sol_AC_doublegate(1+VR1:3:VR1+3*VR2,1));
...
for tt=1:w_row
    ...
    for rr = 1:K_row
        ...
        if K(rr,1) <= R_row2
            ...
            Jn(1,1) = Jn(1,1) + coeff_dJn*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jn(1,1) = Jn(1,1) + coeff_dJn*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2);
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
            ...
            Jn(1,1) = Jn(1,1) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn(1,1) = Jn(1,1) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
            ...
            Jn(1,1) = Jn(1,1) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn(1,1) = Jn(1,1) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp(1,1) = Jp(1,1) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
            Jd(1,1) = Jd(1,1) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
