...
for T_step = 1:Step+1
    ...
    for Newton = 1:20
        ...
        for rr = 1:w_row  % Anode
            ...
            res(3*V+(VR1-2),1) = phi(VR1+V,1)-Thermal_V*log(-Na/nint)-Vanode-Amp*sin(2*pi*freq*t(:,T_step));
            res(3*V+(VR1-1),1) = elec(VR1+V,1)+Na;
            res(3*V+(VR1),1) = hole(VR1+V,1)-(nint^2/-Na);
    ...
    AAA(T_step,1) = phi(51,1);
    AAA_1(T_step,1) = phi(60,1);
