...
% G_phi = Sol_perturbed_AC(:,1:3:T_row);  
% 
% dphi = G_phi(1:3:T_row,x);
% delec = G_phi(2:3:T_row,x);
% dhole = G_phi(3:3:T_row,x);

%%%% Electron perturbation %%%%

G_elec = Sol_perturbed_AC(:,2:3:T_row);  

dphi = G_elec(1:3:T_row,x);
delec = G_elec(2:3:T_row,x);
dhole = G_elec(3:3:T_row,x);

%%%%% Hole perturbation %%%%

% G_hole = Sol_perturbed_AC(:,3:3:T_row);  
% 
% dphi = G_hole(1:3:T_row,x);
% delec = G_hole(2:3:T_row,x);
% dhole = G_hole(3:3:T_row,x);
...
for tt=1:w_row
    ...
    for rr = 1:K_row
        ...
        if K(rr,1) <= R_row2
            ...
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2);
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
            ...
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
            ...
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn_A(1,:) = Jn_A(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp_A(1,:) = Jp_A(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
            Jd_A(1,:) = Jd_A(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
        end
        J_A = (Jn_A+Jp_A+Jd_A);
    end
end
...
for tt=1:m_row
    ...
    for rr = 1:K_row
        ...
        if K(rr,1) <= R_row2
            ...
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1)*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2)*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2);
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V1,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
            ...
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V3,1)-dphi(VR1+V2,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
        ...
        elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
            ...
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((elecDC_av1*ddphi1+delec_av1*dphi_DC1)-Thermal_V*ddelec1));
            Jn_C(1,:) = Jn_C(1,:) + coeff_dJn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((elecDC_av2*ddphi2+delec_av2*dphi_DC2)-Thermal_V*ddelec2));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*((holeDC_av1*ddphi1+dhole_av1*dphi_DC1)+Thermal_V*ddhole1));
            Jp_C(1,:) = Jp_C(1,:) + coeff_dJp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*((holeDC_av2*ddphi2+dhole_av2*dphi_DC2)+Thermal_V*ddhole2));
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V1,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj);
            Jd_C(1,:) = Jd_C(1,:) - esi*e0*(2*pi*freq*i)*(dphi(VR1+V2,1)-dphi(VR1+V3,1))*Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1);
        end
        J_C = (Jn_C+Jp_C+Jd_C);
    end
end
