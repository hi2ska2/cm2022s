    ...
    for tt=1:w_row
        ...
        for rr = 1:K_row
            ...
            if K(rr,1) <= R_row2
                ...
                Jn(bias+1,1) = Jn(bias+1,1) + coeff_Jn*(elec(VR1+V2,1)*Ber(x21) - elec(VR1+V1,1)*Ber(x12))*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                Jn(bias+1,1) = Jn(bias+1,1) + coeff_Jn*(elec(VR1+V3,1)*Ber(x31) - elec(VR1+V1,1)*Ber(x13))*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
                Jp(bias+1,1) = Jp(bias+1,1) + coeff_Jp*(hole(VR1+V2,1)*Ber(x12) - hole(VR1+V1,1)*Ber(x21))*(Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj));
                Jp(bias+1,1) = Jp(bias+1,1) + coeff_Jp*(hole(VR1+V3,1)*Ber(x13) - hole(VR1+V1,1)*Ber(x31))*(Area(K(rr,1)+R_row1,jj+2)/L(K(rr,1)+R_row1,jj+2));
            ...
            elseif K(rr,1) > R_row2 && K(rr,1) <= 2*R_row2
                ...
                Jn(bias+1,1) =  Jn(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(elec(VR1+V1,1)*Ber(x12) - elec(VR1+V2,1)*Ber(x21)));
                Jn(bias+1,1) =  Jn(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(elec(VR1+V3,1)*Ber(x32) - elec(VR1+V2,1)*Ber(x23)));
                Jp(bias+1,1) =  Jp(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(hole(VR1+V1,1)*Ber(x21) - hole(VR1+V2,1)*Ber(x12)));
                Jp(bias+1,1) =  Jp(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(hole(VR1+V3,1)*Ber(x23) - hole(VR1+V2,1)*Ber(x32)));
            ...
            elseif K(rr,1) > 2*R_row2 && K(rr,1) <= 3*R_row2
                ...
                Jn(bias+1,1) = Jn(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(elec(VR1+V1,1)*Ber(x13) - elec(VR1+V3,1)*Ber(x31)));
                Jn(bias+1,1) = Jn(bias+1,1) + coeff_Jn*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(elec(VR1+V2,1)*Ber(x23) - elec(VR1+V3,1)*Ber(x32)));
                Jp(bias+1,1) = Jp(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj)/L(K(rr,1)+R_row1,jj))*(hole(VR1+V1,1)*Ber(x31) - hole(VR1+V3,1)*Ber(x13)));
                Jp(bias+1,1) = Jp(bias+1,1) + coeff_Jp*((Area(K(rr,1)+R_row1,jj-1)/L(K(rr,1)+R_row1,jj-1))*(hole(VR1+V2,1)*Ber(x32) - hole(VR1+V3,1)*Ber(x23)));
            end
